...
class _InvestorSignupPageState extends State<InvestorSignupPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      authProvider.setFormType(FormType.signup); // SET FORM TYPE
      authProvider.enableRealTimeValidation(); // ENABLE VALIDATION
    });
  }
                  ...
                  icon != null
                      ? Container(
                        ...
                        child: Icon(
                          icon,
                          color:
                              hasError ? Colors.red : const Color(0xFF65c6f4),
                          size: 18,
                        ),
                      )
                      : null,
        ...
        if (currentUser != null && !currentUser.isVerified) {
          ...
          if (mounted) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => const InvestorDashboard(),
              ),
            );
          }
        }
